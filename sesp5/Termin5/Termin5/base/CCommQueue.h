 ...
 * <\ol>
 * A queue object must not created by normal <b> new </b>.
 ...
 * Int32 sizeNeeded = CCommQueue::getNumOfBytesNeeded(10);
 * // get the RAM for it
...
public:
   ...
   * @param    waitForever true (=blocking) when the sender can wait
   * 		   (normally only admin's watchdog is allowed to send
   * 		   non-blocking messages to signal a
   * 		   no answering component)
   ...
   */
    ...
    */
   static Int32 getNumOfBytesNeeded(Int32 numOfMsg);
